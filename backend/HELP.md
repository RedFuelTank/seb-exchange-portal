...
* The original package name 'com.seb.exchange-rates' is invalid and this project uses 'com.seb.exchangerates' instead.
...
* [Quartz Scheduler](https://docs.spring.io/spring-boot/docs/3.1.2/reference/htmlsinge/index.html#io.quartz)
